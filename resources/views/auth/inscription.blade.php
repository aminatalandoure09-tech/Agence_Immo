...
<body class="bg-gray-900 flex items-center justify-center min-h-screen font-sans">
    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden my-6">
...
@endif
                ...
                <div class="flex items-center justify-between pt-2">
                    ...
                    <a href="{{ route('connexion') }}" class="text-[10px] text-gray-900 font-medium hover:underline">Déjà inscrit? se connecter</a>
                </div>
            </form>
        </div>
    </div>
